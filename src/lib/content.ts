...
export const services: Service[] = [
  {
    ...
    bestWhen: 'Best when your business looks inconsistent, unclear, or hard to explain.',
  ...
  },
  {
    ...
    bestWhen: 'Best when people are not finding you, remembering you, or taking action.',
    highlight: 'Turn scattered marketing activity into clearer visibility and stronger enquiries.',
    deliverables: [
  ...
  },
  {
    ...
    bestWhen: 'Best when your site looks outdated, feels unclear, or is not generating enough enquiries.',
...
export const processSteps = [
  {
    ...
    description: 'We identify the gaps in your message, offer, website, and marketing so the next move is obvious.',
    output: 'Audit',
  ...
  },
  {
    ...
    description: 'We create the brand, website, and marketing assets needed to turn attention into enquiries.',
  ...
  },
  {
    ...
    description: 'We review performance, feedback, and opportunities so the work keeps getting sharper.',
    output: 'Optimisation',
...
export const resultOutcomes = [
  {
    ...
    description: 'Your brand and website look more credible from the first visit.',
    icon: Sparkles
  },
  {
    label: 'Action',
    title: 'Clearer customer action',
    description: 'Visitors understand what you offer, why it matters, and how to take the next step.',
    icon: MousePointer2
  },
  {
    label: 'Consistency',
    title: 'More consistent presence',
    description: 'Your website, content, and marketing feel connected instead of scattered.',
    icon: Workflow
  }
];
...
export const aboutPageContent = {
  hero: {
    ...
    copy: 'Nodo is a creative agency in Auckland helping service businesses build sharper brands, better websites, and a more consistent digital presence.',
  ...
  story: {
    ...
    copy: 'Nodo was created from the belief that many businesses do not need more noise. They need direction, consistency, and a professional image that reflects who they are and where they want to go.',
    support:
  ...
  positioning: {
    ...
    copy: 'We work beside small and medium-sized businesses that value clarity, quality, and long-term relationships. Every project starts with understanding the business, the audience, and the direction the brand needs to move in.'
  },
  philosophy: {
  ...
  missionVision: [
    {
      ...
      copy: 'To help businesses connect more effectively with their customers through branding, websites, and digital communication systems.'
    },
    {
      label: 'Vision',
      title: 'A leading creative agency for modern digital presence.',
      copy: 'To become a leading creative agency in New Zealand for businesses seeking a consistent, strategic, and professional presence.'
    },
    {
      label: 'Purpose',
      title: 'Connect businesses, people, and ideas.',
      copy: 'To build brands with direction and purpose, so businesses can present themselves with clarity and confidence.'
    }
  ],
  services: [
    {
    ...
    },
    {
      ...
      description: 'Modern, functional, and user-friendly websites designed to support business growth.',
      icon: Blocks
    },
    {
      title: 'Digital Presence',
      description: 'Content, design, and communication that keep the business consistent across digital platforms.',
      icon: Megaphone
    },
    {
      title: 'Ongoing Support',
      description: 'Continued guidance, maintenance, and improvements as the business evolves.',
      icon: PackageCheck
    }
  ...
  values: [
    {
      name: 'Connection',
      description: 'The strongest brands are built through genuine relationships and meaningful collaboration.',
      icon: Handshake
    },
    {
      name: 'Clarity',
      description: 'Effective communication begins with simple, honest, and consistent messaging.',
      icon: Compass
    },
    {
      name: 'Creativity',
      description: 'We combine design, strategy, and functionality to create work with real value.',
      icon: Lightbulb
    },
    {
      name: 'Commitment',
      description: 'We treat every project as if it were our own, taking pride in the work we deliver.',
      icon: BadgeCheck
    },
    {
      name: 'Growth',
      description: 'Businesses evolve, markets change, and brands must continue to grow alongside them.',
      icon: LineChart
    },
    {
      name: 'Speed',
  ...
  closing: {
    ...
    copy: 'The best brands are built when people, ideas, and businesses are meaningfully connected. Nodo creates digital experiences and brand foundations that help businesses grow with clarity, confidence, and purpose.',
    cta: "Let's talk"
  }
};
...
export const servicesPageContent = {
  ...
  positioning: {
    ...
    pillars: [
      {
        title: 'Brand',
        description: 'Make the business easier to recognise and trust.'
      },
      {
        title: 'Marketing',
        description: 'Help the right people find you and understand your value.'
      },
      {
        title: 'Website',
        description: 'Turn attention into enquiries, bookings, or next steps.'
      }
    ]
  },
  detailSection: {
...
export const websiteDesignAucklandPageContent = {
  hero: {
    ...
    title: 'Websites for Auckland businesses that need to look credible and win better enquiries.',
    subtitle:
    ...
    copy: 'Nodo designs and builds websites that make your offer clearer, your business easier to trust, and your next enquiry easier to start.',
    highlights: ['Custom website design', 'Website redesigns', 'Built in Auckland']
  },
  intro: {
    eyebrow: 'What the page needs to do',
    title: 'A good website should make the next decision easier for your customer.',
    copy: 'Most people do not read every section. They scan for credibility, relevance, proof, and a simple next step. We structure your website around those decisions so visitors can quickly understand what you do, why it matters, and how to get in touch.',
    points: [
    ...
    items: [
      {
        ...
        copy: 'If the website feels outdated, customers may assume the service, process, or reliability is outdated too.'
      },
      {
        title: 'People cannot quickly understand what you offer',
        copy: 'Clear structure matters. Visitors should not need to dig through the site to know whether you can help them.'
      },
      {
        title: 'The site gets visits but not enough enquiries',
        copy: 'A website needs stronger calls to action, better proof, and a cleaner journey from interest to contact.'
      }
    ]
  },
  process: {
    ...
    steps: [
      {
        ...
        copy: 'We define what the website needs to communicate, who it needs to persuade, and what action matters most.'
      },
      {
        title: 'Structure the journey',
        copy: 'We map the pages, sections, proof points, and enquiry paths customers need before they feel ready to act.'
      },
      {
        title: 'Design and build',
        copy: 'We create a responsive website that looks sharp, loads well, and supports the way your business sells.'
      },
      {
        title: 'Launch and improve',
        copy: 'We prepare the site for launch with SEO basics, analytics, contact flows, and a path for future improvements.'
      }
    ]
  },
  included: {
  ...
  proof: {
    ...
    copy: 'The redesign replaced an outdated Wix presence with a sharper website built around services, process, project proof, reviews, and quote actions.',
    bullets: [
  ...
  plans: {
    ...
    copy: 'Some businesses need a polished website launched once. Others need ongoing support, updates, SEO basics, and conversion improvements after launch. Nodo can help you choose the right path.',
  ...
  finalCta: {
    ...
    copy: 'Tell us what your current site is not doing well. We will help you decide whether you need a redesign, a new build, or an ongoing website partnership.'
  }
};
...
export type WebsitePlanSlug = Extract<PlanSlug, 'nodo-flow' | 'nodo-growth' | 'nodo-nexus' | 'nodo-launch'>;
...
export const plansHubContent = {
  ...
  positioning: {
    ...
    title: 'Brand builds trust. Marketing brings attention. Your website turns it into enquiries.',
...
export const plansHubCards: PlansHubCard[] = [
  {
    ...
    title: 'Website Plans',
    description: 'Choose this if your website needs to launch, improve, or keep generating enquiries after go-live.',
    href: '/plans/websites',
  ...
  },
  {
    ...
    description: 'Choose this if people need to understand, remember, and trust your business more clearly.',
  ...
  },
  {
    ...
    description: 'Choose this if you want brand, website, and marketing moving in the same direction.',
...
export const plansPageContent = {
  hero: {
    ...
    highlights: ['One-off build available', 'Monthly support available', 'SEO + AI discovery ready']
  },
  positioning: {
...
export const plans: Plan[] = [
  {
    slug: 'nodo-flow',
    name: 'Nodo Flow',
    label: 'Best for a professional website with monthly care',
  ...
  },
  {
    ...
    name: 'Nodo Growth',
    badge: 'Most Popular',
    label: 'Best for more enquiries, stronger visibility, and regular improvements',
    type: 'Digital Growth Partnership',
  ...
  },
  {
    slug: 'nodo-nexus',
    name: 'Nodo Nexus',
    label: 'Best for advanced optimisation, integrations, and strategic support',
    type: 'Digital Growth Partnership',
...
export const planCadenceItems: PlanCadenceItem[] = [
  {
    ...
    points: [
      {
        label: 'First 90 days',
        description: 'Build, onboarding, analytics, SEO structure, and the first improvement roadmap.'
      },
      {
        label: 'Monthly cadence',
        description: 'Updates, maintenance, small improvements, and support to keep the site current.'
      },
      {
        label: 'What gets reported',
        description: 'Website health, enquiry signals, traffic basics, completed updates, and next actions.'
      },
      {
        label: 'What improves over time',
        description: 'Content clarity, service pages, local relevance, trust signals, and enquiry paths.'
      }
    ]
  },
  {
    ...
    points: [
      {
        label: 'First 90 days',
        description: 'Flow setup plus local visibility, Google Business support, and conversion priorities.'
      },
      {
        label: 'Monthly cadence',
        description: 'Optimisation, landing page or growth updates, reporting, and roadmap guidance.'
      },
      {
        label: 'What gets reported',
        description: 'Visibility progress, enquiries, content opportunities, Google Business activity, and priorities.'
      },
      {
        label: 'What improves over time',
        description: 'Local search presence, AI search/GEO basics, conversion paths, and campaign-ready pages.'
      }
    ]
  },
  {
    ...
    points: [
      {
        label: 'First 90 days',
        description: 'Growth setup plus advanced optimisation planning, integrations, and strategic direction.'
      },
      {
        label: 'Monthly cadence',
        description:
      ...
      {
        label: 'What gets reported',
        description: 'Visibility work, conversion priorities, integration progress, support activity, and next steps.'
      },
      {
        label: 'What improves over time',
        description: 'AI search/GEO, lead handling, booking or FAQ flows, integrations, and key user journeys.'
      }
    ]
  },
  {
    ...
    points: [
      {
        label: 'Launch sprint',
        description: 'A focused build from approved scope to a working launch-ready website.'
      },
      {
        label: 'Go-live handover',
        description: 'Launch support, analytics, basic SEO structure, and handover direction.'
      },
      {
        label: 'What gets delivered',
        description: 'Completed website, responsive pages, launch checks, tracking, and agreed scope.'
      },
      {
        label: 'What can improve next',
        description: 'Future content, local visibility, conversion improvements, or ongoing support.'
      }
    ]
  }
];
...
export const marketingPlans: CommercialPlan[] = [
  {
    ...
    label: 'Best for businesses that need to stay active and professional online',
    category: 'Marketing',
    model: 'Monthly plan',
    price: 'From NZD 300/month',
    summary: 'A basic monthly plan for businesses that need a consistent presence without running a full campaign.',
    includedFeatures: [
  ...
  },
  {
    ...
    label: 'Best for businesses that need better content and basic growth activity',
    category: 'Marketing',
    model: 'Monthly plan',
  ...
  },
  {
    ...
    label: 'Best for businesses focused on stronger campaign execution and lead generation',
    category: 'Marketing',
    model: 'Monthly plan',
...
export const brandingPlans: CommercialPlan[] = [
  {
    slug: 'brand-starter',
    name: 'Brand Starter',
    label: 'Best for new businesses that need a clean identity and basic launch assets',
    category: 'Branding',
    model: 'One-off project',
    price: 'From NZD 900',
    summary: 'A professional starting point with the essential identity assets needed to launch with more consistency.',
    includedFeatures: [
      'Logo package',
  ...
  },
  {
    slug: 'brand-growth',
    name: 'Brand Growth',
    label: 'Best for businesses that want stronger visual consistency across channels',
    category: 'Branding',
    model: 'One-off project',
    price: 'From NZD 1,500',
    summary: 'A more refined identity package with stronger visual direction and editable assets for future marketing.',
    includedFeatures: [
  ...
  },
  {
    ...
    label: 'Best for businesses preparing to launch seriously, reposition, or scale',
    category: 'Branding',
    model: 'One-off project',
...
export const bundlePlans: CommercialPlan[] = [
  {
    slug: 'bundle-start',
    name: 'Bundle Start',
    label: 'Best for businesses starting their digital presence with the essentials connected',
    category: 'Bundle',
  ...
  },
  {
    slug: 'bundle-growth',
    name: 'Bundle Growth',
    label: 'Best for businesses that want ongoing visibility, better content, and stronger growth support',
    category: 'Bundle',
    model: 'Connected monthly bundle',
  ...
  },
  {
    slug: 'bundle-scale',
    name: 'Bundle Scale',
    label: 'Best for businesses ready to scale with advanced marketing, brand, and website support',
    category: 'Bundle',
    model: 'Connected monthly bundle',
    price: 'From NZD 4,499/month',
    summary: 'A premium bundle that connects advanced website support, full brand work, and digital marketing.',
    includedFeatures: [
      'Website Nexus',
      'Full Brand & Launch',
      'Full Digital Marketing',
...
export const allPlanOptions = [...plans, ...marketingPlans, ...brandingPlans, ...bundlePlans] satisfies Array<{
  slug: PlanSlug;
  name: string;
}>;
...
export const plansFaq = [
  {
    question: 'What is the difference between Nodo Launch and Flow, Growth, or Nexus?',
    answer:
