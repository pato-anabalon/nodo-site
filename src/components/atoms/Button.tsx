...
const variants = {
  ...
  ghost: 'text-nodo-white hover:bg-white/8 focus-visible:outline-nodo-lavender',
  inverted:
...
export function Button(props: LinkButtonProps | NativeButtonProps) {
  ...
  const variantClasses =
    variant === 'ghost' || variant === 'inverted' ? variants[variant] : variants[surfaceTone][variant];
