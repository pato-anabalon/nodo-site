...
export function Header() {
  ...
  return (
    <header ref={root} data-testid="site-header" className="pointer-events-none fixed inset-x-0 top-0 z-50">
                      ...
                      {plansDropdownLinks.map((link) => {
                        ...
                        return (
                          <Link
                            ...
                            data-testid={`site-header-plans-dropdown-${link.label
                              .toLowerCase()
                              .replace(/[^a-z0-9]+/g, '-')
                              .replace(/^-|-$/g, '')}`}
                            onClick={() => setPreviewHref(item.href)}
