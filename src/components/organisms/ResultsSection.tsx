...
export function ResultsSection() {
  return (
    <section data-testid="home-results-section" className="bg-nodo-black py-24 sm:py-32">
      <Container>
        <div data-testid="home-results-outcomes-layout" className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <ScrollReveal>
            <SectionHeading
          ...
          <div data-testid="home-results-outcome-grid" className="grid gap-4 sm:grid-cols-2">
            {outcomes.map((outcome, index) => (
              <ScrollReveal key={outcome} delay={index * 0.035}>
                <div data-testid={`home-results-outcome-${testIdSlug(outcome)}`} className="flex min-h-20 items-center gap-4 rounded-3xl border border-white/12 bg-white/[0.055] px-5">
        ...
        <div data-testid="home-proof-point-grid" className="mt-20 grid gap-10 md:grid-cols-3">
