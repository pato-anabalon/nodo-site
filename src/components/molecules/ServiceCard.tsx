...
export function ServiceCard({ service, index }: ServiceCardProps) {
  ...
  return (
    <article
      ...
      className="group relative flex h-full min-h-80 flex-col overflow-hidden rounded-[1.75rem] border border-white/12 bg-white/[0.055] p-6 transition duration-300 hover:-translate-y-1 hover:border-nodo-purple/55 hover:bg-white/[0.08] hover:shadow-[0_18px_44px_rgba(124,58,237,0.18)]"
    >
      <p
        aria-hidden="true"
