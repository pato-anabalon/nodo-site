...
export function FooterContactPanel() {
  return (
    <div data-testid="site-footer-contact-panel" className="lg:px-2">
      <p className="text-xs font-black uppercase tracking-[0.22em] text-nodo-lavender">
        Contact
      </p>
      <div className="mt-6 grid gap-4">
        ...
        >
          <span className={iconButtonClass()}>
            <Mail className="relative z-10 size-4 transition duration-300 group-hover/social:-rotate-12 group-hover/social:scale-110" aria-hidden="true" />
          </span>
          <span>
            <span className="block text-xs font-black uppercase tracking-[0.18em] text-white/34">
              Email
            </span>
        ...
        >
          <span className={iconButtonClass()}>
            <Phone className="relative z-10 size-4 transition duration-300 group-hover/social:-rotate-12 group-hover/social:scale-110" aria-hidden="true" />
          </span>
          <span>
            <span className="block text-xs font-black uppercase tracking-[0.18em] text-white/34">
              Phone
          ...
          {socialLinks.map((link) => {
            ...
            if (!link.href) {
              return (
                ...
                >
                  <Icon className="relative z-10 size-4 transition duration-300 group-hover/social:-rotate-12 group-hover/social:scale-110" aria-hidden="true" />
                </span>
              );
            }
