...
describe("page templates", () => {
  ...
  it("should render AboutPage", () => {
    ...
    expect(
      screen
        .getByTestId("about-values-section")
        .compareDocumentPosition(screen.getByTestId("about-services-section")),
    ...
    expect(
      screen.queryByTestId("about-client-panel-emerging-brands-and-growing-businesses"),
