...
export function ServicesPage() {
    ...
    () => {
      ...
      mm.add('(prefers-reduced-motion: no-preference)', () => {
        ...
        tl.to('.services-hero-kicker', { autoAlpha: 1, y: 0, duration: 0.7 })
          .to('.services-hero-title-word', { yPercent: 0, duration: 0.85, stagger: 0.08 }, '-=0.25')
  ...
  return (
    <main ref={root} data-testid="services-page-main" className="overflow-hidden bg-nodo-black">
      <section
      ...
      >
        ...
        <Container className="relative z-10 grid items-center gap-12 pb-16 pt-10 lg:grid-cols-[1fr_0.78fr]">
          <div data-testid="services-page-hero-content">
            <p
              data-testid="services-page-hero-eyebrow"
              className="services-hero-kicker opacity-0 motion-reduce:opacity-100 mb-5 text-sm font-black uppercase tracking-[0.24em] text-nodo-purple"
            >
              {servicesPageContent.hero.eyebrow}
            </p>
            <h1
              data-testid="services-page-hero-title"
              className="services-hero-title opacity-0 motion-reduce:opacity-100 max-w-5xl text-balance text-5xl font-black leading-[0.9] tracking-normal text-nodo-black sm:text-7xl lg:text-8xl"
            >
            ...
            {servicesPageContent.hero.subtitle ? (
              <p
                data-testid="services-page-hero-subtitle"
                className="services-hero-copy opacity-0 motion-reduce:opacity-100 mt-7 max-w-3xl text-pretty text-xl font-semibold leading-8 text-nodo-ink/82 sm:text-2xl"
              >
                {servicesPageContent.hero.subtitle}
              </p>
            ) : null}
            <p
              data-testid="services-page-hero-copy"
              className="services-hero-copy opacity-0 motion-reduce:opacity-100 mt-5 max-w-2xl text-pretty text-lg leading-8 text-nodo-ink/68"
            >
          ...
          <div data-testid="services-page-hero-visual" className="services-hero-visual relative flex items-center pb-2">
            <div className="services-hero-visual-part relative overflow-hidden rounded-[2.2rem] border border-black/8 bg-[linear-gradient(145deg,#f8f4ff_0%,#ffffff_48%,#fbf8ff_100%)] p-4 shadow-[0_28px_90px_rgba(22,19,25,0.12)] opacity-0 motion-reduce:opacity-100 sm:p-5">
              ...
              <div
                data-testid="services-page-hero-video-caption"
                className="services-hero-visual-part absolute inset-x-8 bottom-8 rounded-[1.4rem] border border-white/35 bg-white/84 px-5 py-4 backdrop-blur-md opacity-0 motion-reduce:opacity-100"
              >
      ...
      >
        <Container>
          <ScrollReveal>
            <div
              data-testid="services-page-positioning-layout"
              className="grid gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center"
            >
              <div
                data-testid="services-page-positioning-video-card"
                className="relative overflow-hidden rounded-[2rem] border border-black/8 bg-[linear-gradient(145deg,#f8f5ff_0%,#ffffff_48%,#f7f2ff_100%)] p-6 sm:p-8"
              >
                ...
                <div className="relative min-h-[22rem] overflow-hidden rounded-[1.6rem] border border-black/8 bg-white/72 shadow-[0_24px_90px_rgba(22,19,25,0.08)]">
                  ...
                  <div
                    data-testid="services-page-positioning-video-caption"
                    className="absolute bottom-5 left-5 right-5 rounded-[1.35rem] border border-white/30 bg-white/78 px-4 py-4 backdrop-blur-md"
                  >
                    <p className="text-[0.65rem] font-black uppercase tracking-[0.18em] text-nodo-purple">
                      Brand / Marketing / Website
                    </p>
                    <p className="mt-2 text-sm font-semibold leading-6 text-nodo-ink/78">
                      One connected direction designed to help your business look sharper, generate more demand, and
              ...
              <div data-testid="services-page-positioning-content">
                <p
                  data-testid="services-page-positioning-eyebrow"
                  className="text-sm font-black uppercase tracking-[0.24em] text-nodo-purple"
                >
                  {servicesPageContent.positioning.eyebrow}
                </p>
                <h2
                  data-testid="services-page-positioning-title"
                  className="mt-5 text-balance text-4xl font-black leading-[0.95] text-nodo-black sm:text-6xl"
                >
                  {servicesPageContent.positioning.title}
                </h2>
                <p
                  data-testid="services-page-positioning-copy"
                  className="mt-6 max-w-3xl text-pretty text-lg leading-8 text-nodo-ink/68"
                >
                ...
                <div data-testid="services-page-positioning-pillars" className="mt-8 grid gap-4 sm:grid-cols-3">
                  {servicesPageContent.positioning.pillars.map((pillar, index) => (
                    ...
                    >
                      ...
                      <p className="relative z-10 text-base font-black text-nodo-black">{pillar.title}</p>
                      <p className="relative z-10 mt-2 text-sm leading-6 text-nodo-ink/66">{pillar.description}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section id="service-breakdown" data-testid="services-page-breakdown-section" className="py-20 sm:py-28">
        <Container>
          <ScrollReveal>
            <SectionHeading
      ...
      <section data-testid="services-page-final-cta-section" className="bg-nodo-purple py-20 text-white sm:py-28">
        <Container>
          <ScrollReveal>
            <div
              data-testid="services-page-final-cta-layout"
              className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end"
            >
              <div>
                <p
                  data-testid="services-page-final-cta-eyebrow"
                  className="mb-5 text-sm font-black uppercase tracking-[0.24em] text-white/70"
                >
                  {servicesPageContent.finalCta.eyebrow}
                </p>
                <h2
                  data-testid="services-page-final-cta-title"
                ...
                <p
                  data-testid="services-page-final-cta-copy"
